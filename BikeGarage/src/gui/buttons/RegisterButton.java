...
public class RegisterButton extends JButton implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(socSecNum == null || socSecNum.isEmpty()){
			...
			switch (JOptionPane.showConfirmDialog(null, "�r du s�ker p� att du vill registrera en ny anv�ndare?")) {
			case JOptionPane.YES_OPTION:
				System.out.println("Registrera Anv�ndare");
//				cl.show(main.getUIPane(), BikeGarageGUI.REGOWNERPANE);
				...
				case JOptionPane.OK_OPTION:
					System.out.println("Indata bekr�ftad");
